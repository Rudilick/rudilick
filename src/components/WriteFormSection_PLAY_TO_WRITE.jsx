  ...
  return (
    <div className="w-full max-w-xl mx-auto mt-12 px-4 py-6 rounded-2xl shadow-lg bg-gray-900 text-white border border-gray-700">
      ...
      <div className="flex gap-4">
        <button onClick={handleRecord} disabled={recording} className="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-2 rounded-xl font-semibold">
          PLAY TO WRITE
        </button>
        <button onClick={stopRecording} disabled={!recording} className="flex-1 bg-red-500 hover:bg-red-600 text-white py-2 rounded-xl font-semibold">
          FINISH
        </button>
      </div>
    </div>
